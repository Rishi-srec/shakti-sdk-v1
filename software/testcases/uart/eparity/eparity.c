...
/**! Procedure to test
	1. Configure SoC UART for even partity.
	2. Configure miniterm for even parity.
	...
	5. Configure miniterm for odd parity.
	...
	SoC transmits data.
	1. Configure UART for even partity.
	2. Configure miniterm for even parity.
...
void main()
{
	...
	uart_instance[0]->control = value | PARITY(2);
	printf("\n Hello world");
	while(1)
	{
